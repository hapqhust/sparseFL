...
class Server(BasicServer):
    ...
    def iterate(self, t):
        ...
        # -> Danh sách nhận về theo thứ tự của selected_clients
        
        # src_model = copy.deepcopy(self.model)
        # src_model.freeze_grad()
        # dys = [model - src_model for model in models_phase_2] 
        # Ks = [(Ks1[idx] + Ks1[shuffled_list.index(client_id)]) for idx, client_id in enumerate(self.selected_clients)]
