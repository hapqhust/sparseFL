...
json.dump(output, open(dir_path + "mnist_cluster_sparse.json", "w"), indent=4, cls=NpEncoder)
...
np.savetxt(dir_path + "mnist_cluster_sparse_stat.csv", stat, delimiter=",", fmt="%d")
