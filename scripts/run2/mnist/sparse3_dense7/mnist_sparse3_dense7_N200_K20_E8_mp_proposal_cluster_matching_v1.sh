...
cp -r ./sparseFL/benchmark/mnist/data ${DATA_DIR}
        ...
        GROUP="mnist_sparse3_dense7_N200_K20_E8"
        ALG="mp_proposal_cluster_matching_v1"
        MODEL="cnn"
        WANDB=1
        ROUND=1000
        EPOCH_PER_ROUND=8
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="mnist_sparse3_dense7_N200_K20_E8"
        DATA_IDX_FILE="mnist/sparse3_dense7/200client/mnist_sparse3_dense7.json"
