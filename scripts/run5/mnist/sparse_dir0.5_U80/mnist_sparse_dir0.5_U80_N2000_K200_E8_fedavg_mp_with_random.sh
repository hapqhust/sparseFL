...
cp -r ./sparseFL/benchmark/mnist/data ${DATA_DIR}
        ...
        GROUP="mnist_sparse_dir0.5_U80_N2000_K200_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="mnist_sparse_dir0.5_U80_N2000_K200_E8"
        DATA_IDX_FILE="mnist/sparse_dir0.5_U80/2000client/mnist_sparse.json"
