...
cp -r ./sparseFL/benchmark/cifar100/data ${DATA_DIR}
        ...
        GROUP="cifar100_sparse_dir0.5_U100_N1000_K100_E8"
        ALG="fedavg_mp_with_random"
        MODEL="resnet9"
        WANDB=1
        ROUND=1000
        EPOCH_PER_ROUND=8
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="cifar100_sparse_dir0.5_U100_N1000_K100_E8"
        DATA_IDX_FILE="cifar100/sparse_dir0.5_U100/1000client/cifar100_sparse.json"
