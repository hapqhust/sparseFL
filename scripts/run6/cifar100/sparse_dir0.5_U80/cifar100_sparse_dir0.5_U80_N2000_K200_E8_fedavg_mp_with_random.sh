...
cp -r ./sparseFL/benchmark/cifar100/data ${DATA_DIR}
        ...
        GROUP="cifar100_sparse_dir0.5_U80_N2000_K200_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="cifar100_sparse_dir0.5_U80_N2000_K200_E8"
        DATA_IDX_FILE="cifar100/sparse_dir0.5_U80/2000client/cifar100_sparse.json"
