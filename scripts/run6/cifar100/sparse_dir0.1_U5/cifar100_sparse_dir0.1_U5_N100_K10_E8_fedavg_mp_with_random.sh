...
cp -r ./sparseFL/benchmark/cifar100/data ${DATA_DIR}
        ...
        GROUP="cifar100_sparse_dir0.1_U5_N100_K10_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="cifar100_sparse_dir0.1_U5_N100_K10_E8"
        DATA_IDX_FILE="cifar100/sparse_dir0.1_U5/100client/cifar100_sparse.json"
