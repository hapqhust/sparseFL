...
cp -r ./sparseFL/benchmark/cifar10/data ${DATA_DIR}
        ...
        GROUP="cifar10_sparse_dir0.2_U20.0_N500_K50_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="cifar10_sparse_dir0.2_U20.0_N500_K50_E8"
        DATA_IDX_FILE="cifar10/sparse_dir0.2_U20.0/500client/cifar10_sparse.json"
