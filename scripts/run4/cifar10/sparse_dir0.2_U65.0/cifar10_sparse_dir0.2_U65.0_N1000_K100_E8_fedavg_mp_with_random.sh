...
cp -r ./sparseFL/benchmark/cifar10/data ${DATA_DIR}
        ...
        GROUP="cifar10_sparse_dir0.2_U65.0_N1000_K100_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="cifar10_sparse_dir0.2_U65.0_N1000_K100_E8"
        DATA_IDX_FILE="cifar10/sparse_dir0.2_U65.0/1000client/cifar10_sparse.json"
