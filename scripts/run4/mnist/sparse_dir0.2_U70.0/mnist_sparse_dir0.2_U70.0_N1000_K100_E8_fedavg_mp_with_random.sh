...
cp -r ./sparseFL/benchmark/mnist/data ${DATA_DIR}
        ...
        GROUP="mnist_sparse_dir0.2_U70.0_N1000_K100_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="mnist_sparse_dir0.2_U70.0_N1000_K100_E8"
        DATA_IDX_FILE="mnist/sparse_dir0.2_U70.0/1000client/mnist_sparse.json"
