...
cp -r ./sparseFL/benchmark/mnist/data ${DATA_DIR}
        ...
        GROUP="mnist_sparse_dir0.1_U90.0_N500_K50_E8"
        ...
        NUM_GPUS=1
        SERVER_GPU_ID=0
        TASK="mnist_sparse_dir0.1_U90.0_N500_K50_E8"
        DATA_IDX_FILE="mnist/sparse_dir0.1_U90.0/500client/mnist_sparse.json"
